package com.kh.Super.member.domain;
...
public class MemberVO {
	...
	public MemberVO(String memberId, String memberPw, String memberEmail, String memberPhone, String memberAddress, String memberHobby) {
		super();
